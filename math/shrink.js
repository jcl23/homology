...
const computePlaneNormal = (A, B, C) => {
...
const projectTo2D = (A, B, C, normal) => {
...
const computeOrthocenter2D = (A2D, B2D, C2D) => {
    let slopeAB = null;
    let slopeAC = null;
    ...
    let altitudeBSlope = null;
    let altitudeCSlope = null;
    if (slopeAC === 0) {
    ...
    let altitudeBIntercept;
    let altitudeCIntercept;
...
const mapTo3D = (orthocenter2D, A, u, v) => {
...
const computeOrthocenter3D = (triangleVertices) => {
